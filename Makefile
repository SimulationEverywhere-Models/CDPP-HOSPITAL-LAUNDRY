...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  hospital.o laundryCleaning.o laundryShipping.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#J
...
#^|
hospital.o: /cygdrive/C/eclipse/workspace/HospitalLaundry/hospital.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
laundryCleaning.o: /cygdrive/C/eclipse/workspace/HospitalLaundry/laundryCleaning.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
laundryShipping.o: /cygdrive/C/eclipse/workspace/HospitalLaundry/laundryShipping.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/HospitalLaundry/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
hospital.o: /cygdrive/C/eclipse/workspace/HospitalLaundry/hospital.cpp \
 /cygdrive/C/eclipse/workspace/HospitalLaundry/hospital.h \
...
laundryCleaning.o: \
 /cygdrive/C/eclipse/workspace/HospitalLaundry/laundryCleaning.cpp \
 /cygdrive/C/eclipse/workspace/HospitalLaundry/laundryCleaning.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
laundryShipping.o: \
 /cygdrive/C/eclipse/workspace/HospitalLaundry/laundryShipping.cpp \
 /cygdrive/C/eclipse/workspace/HospitalLaundry/laundryShipping.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
